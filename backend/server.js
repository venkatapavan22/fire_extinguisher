...
// app.get('/api/extinguishers/:trainNumber', async (req, res) => {
...
//     try {
//         const currentDate = new Date('2025-03-27'); // Hardcoding for testing
...
//             expiryDate: { 
//                 $gte: currentDate, // Not expired yet
...
// // New route for expiring by train number
// app.get('/api/expiring/:trainNumber', async (req, res) => {
//     try {
//         const currentDate = new Date('2025-03-27'); // Hardcoding for testing
//         const thirtyDaysFromNow = new Date(currentDate);
//         thirtyDaysFromNow.setDate(currentDate.getDate() + 30);
